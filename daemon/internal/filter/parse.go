...
func FromJSON(p string) (Args, error) {
	...
	args = deprecatedArgs(deprecated)
	return args, nil
}
...
func (args Args) Add(key, value string) {
	if _, ok := args[key]; ok {
		...
		args[key] = map[string]bool{value: true}
	}
}
...
func (args Args) Clone() (newArgs Args) {
	newArgs = make(map[string]map[string]bool, len(args))
	for k, m := range args {
...
func (a Args) APIFilters() filters.Args {
